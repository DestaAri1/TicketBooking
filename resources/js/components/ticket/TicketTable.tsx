...
const TableHeadItem = [{ title: 'Event Details' }, { title: 'Date & Time' }, { title: 'Venue' }, { title: 'Price & Sales' }, { title: 'Status' }];
...
export default function TicketTable({ tickets, selectedTickets, toggleSelectAll, toggleSelectTicket, onDelete, searchQuery }: TicketTableProps) {
    const actionItems = (id: number) => [
        {
            title: 'View',
            href: `/dashboard/ticket/view/${id}`,
            icon: <Eye className="h-4 w-4" />,
            type: 'link',
        },
        {
            title: 'Edit',
            href: `/dashboard/ticket/edit/${id}`,
    ...
    return (
        ...
        //                                     {actionItems(ticket.id).map((action, index) =>
        //                                         action.type === 'link' ? (
        //                                             <Link
        //                                                 key={index}
        //                                                 href={action.href!}
